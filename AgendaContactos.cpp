...
void AgendaContactos::ordenarContactosPorNombre()
{
  ...
  for (size_t i = 0; i < contactos.size(); ++i) // Bucle externo sera el numero de pasadas
  {
    for (size_t j = 0; j < contactos.size() - i - 1; ++j) // Bucle interno para comparaciones
    {
      ...
      {
        swap(contactos[j], contactos[j + 1]); // Intercambiar contactos
      }
    }
  }
}
...
void AgendaContactos::listarContactos()
{
  ...
  {
    cout << "- Nombre: " << contacto.nombre << ", Numero: " << contacto.numero << ", Email: " << contacto.email << "\n";
  }
}
...
void AgendaContactos::buscarContacto(string nombre)
{
  ...
  while (izquierda <= derecha)
  {
    ...
    {
      cout << "\nContacto encontrado:\n";
      cout << "Nombre: " << contactos[medio].nombre << "\n";
      cout << "Numero: " << contactos[medio].numero << "\n";
      cout << "Email: " << contactos[medio].email << "\n";
      encontrado = true;
      break; // Salir del bucle al encontrar el contacto
    }
